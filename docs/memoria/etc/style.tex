...
\lstdefinelanguage{Solidity}{
    keywords={contract, struct, enum, mapping, public, private, internal, external, pure, view, payable, returns, return, require, revert, address, uint256, bool, string, memory, storage, calldata, event, indexed, emit, constructor, function, modifier, true, false},
    keywordstyle=\color{blue}\bfseries,
    ndkeywords={TradeState, Trade, CardData, SwapOffer},
