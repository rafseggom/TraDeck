...
En aplicaciones tradicionales, el backend utiliza diversos drivers para comunicarse con la base de datos. En TraDeck, esta función la cumple \textbf{Ethers.js}. 
...
La interfaz ha sido diseñada para abstraer la complejidad de la blockchain. A continuación se muestran capturas de los módulos principales:

% AQUI TENEMOSQ UE METER IMAGENES. 
% Subir capturas a la carpeta img/ y cambiar los nombres de los archivos.

\begin{figure}[h]
	\centering
	% \includegraphics[width=0.8\textwidth]{img/captura_mercado.png}
	\caption{Vista principal del mercado descentralizado de TraDeck.}
	\label{fig:mercado}
\end{figure}

\begin{figure}[h]
	\centering
	% \includegraphics[width=0.8\textwidth]{img/captura_intercambio.png}
	\caption{Interfaz de propuesta de intercambio atómico (Trueque).}
