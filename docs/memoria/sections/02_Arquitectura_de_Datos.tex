...
\begin{figure}[H]
	...
	\caption{Arquitectura técnica de un bloque: Relación entre el árbol de Merkle y el encadenamiento de hashes anteriores. \textbf{Fuente:} \cite{wiki_merkle}.}
...
\begin{figure}[H]
	...
	\caption{Línea de tiempo de confirmaciones: Aumento del grado de seguridad y enterramiento de la transacción conforme avanza el ledger. \textbf{Fuente:} Adaptado de \cite{medium_finality}.}
