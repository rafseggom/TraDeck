...
El código fuente íntegro del proyecto, incluyendo los Smart Contracts, el proxy y la interfaz frontend, está disponible de forma pública en el siguiente repositorio de GitHub: \url{https://github.com/rafseggom/TraDeck}.
...
\begin{table}[H]
	...
	\begin{tabular}{|l|c|c|}
		...
		Configuración inicial del entorno & 5h & Javi \\ \hline
		Investigación y Diseño de Arquitectura (Blockchain vs SQL) & 10h & Ambos \\ \hline
		Desarrollo de Smart Contracts (Solidity) y Tests Unitarios & 15h & Javi \\ \hline
		Desarrollo del Frontend (React, Ethers.js y UI/UX) & 18h & Rafa \\ \hline
		Integración de Servicios Off-chain (IPFS, Pinata y Proxy) & 7h & Ambos \\ \hline
		Despliegue (Hardhat, Sepolia, Vercel y Render) & 4h & Rafa \\ \hline
		Redacción de Memoria Técnica y Documentación & 6h & Ambos \\ \hline
		\textbf{Total de horas de trabajo} & \textbf{65h} & \\ \hline
	\end{tabular}
	\caption{Desglose de horas y reparto de tareas por fase del proyecto.}
	\label{tab:planificacion}
\end{table}

Es importante destacar que hemos dedicado mucho tiempo, que no hemos querido añadir a las estimaciones, a investigación y decisiones técnica: aprender sobre la blockchain, qué alcance podría tener nuestro proyecto, como tokenizar las cartas, experimentar y hacer pruebas, ver cómo de vialbe es, tecnología a usar (Remix vs HardHat), etc. 